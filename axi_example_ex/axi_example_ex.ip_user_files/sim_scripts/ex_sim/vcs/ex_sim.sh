...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../axi_example_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/home/data/tools/Xilinx24/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../axi_example_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/home/data/tools/Xilinx24/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../axi_example_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/home/data/tools/Xilinx24/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../bd/ex_sim/ip/ex_sim_axi_vip_mst_0/sim/ex_sim_axi_vip_mst_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_19 $vlogan_opts -sverilog +incdir+"../../../../axi_example_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/home/data/tools/Xilinx24/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../axi_example_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/home/data/tools/Xilinx24/Vivado/2024.2/data/xilinx_vip/include" \
...
reset_run()
{
  files_to_remove=(ucli.key ex_sim_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ex_sim_simv.daidir vcs_lib c.obj)
