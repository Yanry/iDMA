...
#
# Script generated by Vivado on Sun Jan 19 14:01:44 CST 2025
...
#
# Usage        : ex_sim.sh
#                ex_sim.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ex_sim.sh [-reset_run]
#                ex_sim.sh [-reset_log]
#                ex_sim.sh [-help]
#
...
#                script (type 'ex_sim.sh -help' for more information).
#
...
# script info
echo -e "ex_sim.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ex_sim.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../axi_example_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/home/data/tools/Xilinx24/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../axi_example_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/home/data/tools/Xilinx24/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../axi_example_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/home/data/tools/Xilinx24/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../bd/ex_sim/ip/ex_sim_axi_vip_mst_0/sim/ex_sim_axi_vip_mst_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_19 $xmvlog_opts -sv +incdir+"../../../../axi_example_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/home/data/tools/Xilinx24/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../axi_example_ex.gen/sources_1/bd/ex_sim/ipshared/ec67/hdl" +incdir+"/home/data/tools/Xilinx24/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ex_sim xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ex_sim -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ex_sim_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ex_sim.sh [-step]\n\
Usage: ex_sim.sh [-lib_map_path]\n\
Usage: ex_sim.sh [-reset_run]\n\
Usage: ex_sim.sh [-reset_log]\n\
Usage: ex_sim.sh [-keep_index]\n\
