...
// Date        : Fri Jan  3 15:26:31 2025
// Host        : dell running 64-bit Ubuntu 20.04.6 LTS
// Command     : write_verilog -force -mode synth_stub
//               /home/yanry/dma/z19_iDMA/z19_iDMA.tmp/dma_core_wrap_v_v1_0_project/z19_iDMA/z19_iDMA.gen/sources_1/bd/design_1/ip/design_1_dma_core_wrap_v_0_2/design_1_dma_core_wrap_v_0_2_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_dma_core_wrap_v_0_2,dma_core_wrap_v,{}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) (* IP_DEFINITION_SOURCE = "package_project" *) 
(* X_CORE_INFO = "dma_core_wrap_v,Vivado 2024.2" *) 
module design_1_dma_core_wrap_v_0_2(clk, rst_n, testmode, axi_mst_req_aw_id, 
  ...
  axi_slv_req_r_ready)
/* synthesis syn_black_box black_box_pad_pin="rst_n,testmode,axi_mst_req_aw_id[0:0],axi_mst_req_aw_addr[31:0],axi_mst_req_aw_len[7:0],axi_mst_req_aw_size[2:0],axi_mst_req_aw_burst[1:0],axi_mst_req_aw_lock,axi_mst_req_aw_cache[3:0],axi_mst_req_aw_prot[2:0],axi_mst_req_aw_qos[3:0],axi_mst_req_aw_region[3:0],axi_mst_req_aw_atop[5:0],axi_mst_req_aw_user[3:0],axi_mst_req_aw_valid,axi_mst_rsp_aw_ready,axi_mst_req_w_data[31:0],axi_mst_req_w_strb[3:0],axi_mst_req_w_last,axi_mst_req_w_user[3:0],axi_mst_req_w_valid,axi_mst_rsp_w_ready,axi_mst_rsp_b_id[0:0],axi_mst_rsp_b_resp[1:0],axi_mst_rsp_b_user[3:0],axi_mst_rsp_b_valid,axi_mst_req_b_ready,axi_mst_req_ar_id[0:0],axi_mst_req_ar_addr[31:0],axi_mst_req_ar_len[7:0],axi_mst_req_ar_size[2:0],axi_mst_req_ar_burst[1:0],axi_mst_req_ar_lock,axi_mst_req_ar_cache[3:0],axi_mst_req_ar_prot[2:0],axi_mst_req_ar_qos[3:0],axi_mst_req_ar_region[3:0],axi_mst_req_ar_user[3:0],axi_mst_req_ar_valid,axi_mst_rsp_ar_ready,axi_mst_rsp_r_id[0:0],axi_mst_rsp_r_data[31:0],axi_mst_rsp_r_resp[1:0],axi_mst_rsp_r_last,axi_mst_rsp_r_user[3:0],axi_mst_rsp_r_valid,axi_mst_req_r_ready,axi_slv_req_aw_id[0:0],axi_slv_req_aw_addr[31:0],axi_slv_req_aw_len[7:0],axi_slv_req_aw_size[2:0],axi_slv_req_aw_burst[1:0],axi_slv_req_aw_lock,axi_slv_req_aw_cache[3:0],axi_slv_req_aw_prot[2:0],axi_slv_req_aw_qos[3:0],axi_slv_req_aw_region[3:0],axi_slv_req_aw_atop[5:0],axi_slv_req_aw_user[3:0],axi_slv_req_aw_valid,axi_slv_rsp_aw_ready,axi_slv_req_w_data[31:0],axi_slv_req_w_strb[3:0],axi_slv_req_w_last,axi_slv_req_w_user[3:0],axi_slv_req_w_valid,axi_slv_rsp_w_ready,axi_slv_rsp_b_id[0:0],axi_slv_rsp_b_resp[1:0],axi_slv_rsp_b_user[3:0],axi_slv_rsp_b_valid,axi_slv_req_b_ready,axi_slv_req_ar_id[0:0],axi_slv_req_ar_addr[31:0],axi_slv_req_ar_len[7:0],axi_slv_req_ar_size[2:0],axi_slv_req_ar_burst[1:0],axi_slv_req_ar_lock,axi_slv_req_ar_cache[3:0],axi_slv_req_ar_prot[2:0],axi_slv_req_ar_qos[3:0],axi_slv_req_ar_region[3:0],axi_slv_req_ar_user[3:0],axi_slv_req_ar_valid,axi_slv_rsp_ar_ready,axi_slv_rsp_r_id[0:0],axi_slv_rsp_r_data[31:0],axi_slv_rsp_r_resp[1:0],axi_slv_rsp_r_last,axi_slv_rsp_r_user[3:0],axi_slv_rsp_r_valid,axi_slv_req_r_ready" */
/* synthesis syn_force_seq_prim="clk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF axi_mst:axi_slv, FREQ_HZ 100000000, ASSOCIATED_RESET rst_n, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_clk_wiz_1_1_clk_out1, INSERT_VIP 0" *) input clk /* synthesis syn_isclock = 1 */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 rst_n RST" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME rst_n, POLARITY ACTIVE_LOW, INSERT_VIP 0" *) input rst_n;
  input testmode;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst AWID" *) (* X_INTERFACE_MODE = "master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME axi_mst, DATA_WIDTH 32, PROTOCOL AXI4, FREQ_HZ 100000000, ID_WIDTH 1, ADDR_WIDTH 32, AWUSER_WIDTH 4, ARUSER_WIDTH 4, WUSER_WIDTH 4, RUSER_WIDTH 4, BUSER_WIDTH 4, READ_WRITE_MODE READ_WRITE, HAS_BURST 1, HAS_LOCK 1, HAS_PROT 1, HAS_CACHE 1, HAS_QOS 1, HAS_REGION 1, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, SUPPORTS_NARROW_BURST 1, NUM_READ_OUTSTANDING 2, NUM_WRITE_OUTSTANDING 2, MAX_BURST_LENGTH 256, PHASE 0.0, CLK_DOMAIN design_1_clk_wiz_1_1_clk_out1, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0" *) output [0:0]axi_mst_req_aw_id;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst AWADDR" *) output [31:0]axi_mst_req_aw_addr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst AWUSER" *) output [3:0]axi_mst_req_aw_user;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst WDATA" *) output [31:0]axi_mst_req_w_data;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst WSTRB" *) output [3:0]axi_mst_req_w_strb;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst WLAST" *) output axi_mst_req_w_last;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst WUSER" *) output [3:0]axi_mst_req_w_user;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst BUSER" *) input [3:0]axi_mst_rsp_b_user;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst ARADDR" *) output [31:0]axi_mst_req_ar_addr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst ARUSER" *) output [3:0]axi_mst_req_ar_user;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst RDATA" *) input [31:0]axi_mst_rsp_r_data;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst RUSER" *) input [3:0]axi_mst_rsp_r_user;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv AWID" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME axi_slv, DATA_WIDTH 32, PROTOCOL AXI4, FREQ_HZ 100000000, ID_WIDTH 1, ADDR_WIDTH 32, AWUSER_WIDTH 4, ARUSER_WIDTH 4, WUSER_WIDTH 4, RUSER_WIDTH 4, BUSER_WIDTH 4, READ_WRITE_MODE READ_WRITE, HAS_BURST 1, HAS_LOCK 1, HAS_PROT 1, HAS_CACHE 1, HAS_QOS 1, HAS_REGION 1, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, SUPPORTS_NARROW_BURST 1, NUM_READ_OUTSTANDING 2, NUM_WRITE_OUTSTANDING 2, MAX_BURST_LENGTH 256, PHASE 0.0, CLK_DOMAIN design_1_clk_wiz_1_1_clk_out1, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0" *) input [0:0]axi_slv_req_aw_id;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv AWADDR" *) input [31:0]axi_slv_req_aw_addr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv AWUSER" *) input [3:0]axi_slv_req_aw_user;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv WDATA" *) input [31:0]axi_slv_req_w_data;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv WSTRB" *) input [3:0]axi_slv_req_w_strb;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv WLAST" *) input axi_slv_req_w_last;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv WUSER" *) input [3:0]axi_slv_req_w_user;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv BUSER" *) output [3:0]axi_slv_rsp_b_user;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv ARADDR" *) input [31:0]axi_slv_req_ar_addr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv ARUSER" *) input [3:0]axi_slv_req_ar_user;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv RDATA" *) output [31:0]axi_slv_rsp_r_data;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv RUSER" *) output [3:0]axi_slv_rsp_r_user;
