...
-- Command     : write_vhdl -force -mode synth_stub -rename_top design_1_reg_to_axi_v_0_0 -prefix
--               design_1_reg_to_axi_v_0_0_ reg_to_axi_v_0_stub.vhdl
...
architecture stub of design_1_reg_to_axi_v_0_0 is
  attribute syn_black_box : boolean;
  attribute black_box_pad_pin : string;
  attribute syn_black_box of stub : architecture is true;
  attribute black_box_pad_pin of stub : architecture is "clk_i,rst_ni,reg_req_addr[63:0],reg_req_write,reg_req_wdata[63:0],reg_req_wstrb[7:0],reg_req_valid,reg_rsp_rdata[63:0],reg_rsp_error,reg_rsp_ready,axi_req_aw_id[0:0],axi_req_aw_addr[63:0],axi_req_aw_len[7:0],axi_req_aw_size[2:0],axi_req_aw_burst[1:0],axi_req_aw_lock,axi_req_aw_cache[3:0],axi_req_aw_prot[2:0],axi_req_aw_qos[3:0],axi_req_aw_region[3:0],axi_req_aw_atop[5:0],axi_req_aw_user[0:0],axi_req_aw_valid,axi_rsp_aw_ready,axi_req_w_data[63:0],axi_req_w_strb[7:0],axi_req_w_last,axi_req_w_user[0:0],axi_req_w_valid,axi_rsp_w_ready,axi_rsp_b_id[0:0],axi_rsp_b_resp[1:0],axi_rsp_b_user[0:0],axi_rsp_b_valid,axi_req_b_ready,axi_req_ar_id[0:0],axi_req_ar_addr[63:0],axi_req_ar_len[7:0],axi_req_ar_size[2:0],axi_req_ar_burst[1:0],axi_req_ar_lock,axi_req_ar_cache[3:0],axi_req_ar_prot[2:0],axi_req_ar_qos[3:0],axi_req_ar_region[3:0],axi_req_ar_user[0:0],axi_req_ar_valid,axi_rsp_ar_ready,axi_rsp_r_id[0:0],axi_rsp_r_data[63:0],axi_rsp_r_resp[1:0],axi_rsp_r_last,axi_rsp_r_user[0:0],axi_rsp_r_valid,axi_req_r_ready";
  ...
  attribute X_CORE_INFO of stub : architecture is "reg_to_axi_v,Vivado 2024.2";
begin
end;
