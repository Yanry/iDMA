module axi_addr_offset_v #(
    ...
    // AXI Slave Interface
    // AW Channel
    input  wire [AxiIdWidth-1:0]     axi_slv_req_aw_id,
    ...
    // B Channel
    output wire [AxiIdWidth-1:0]     axi_slv_rsp_b_id,
    ...
    // AR Channel
    input  wire [AxiIdWidth-1:0]     axi_slv_req_ar_id,
    ...
    // R Channel
    output wire [AxiIdWidth-1:0]     axi_slv_rsp_r_id,
    ...
    // Addr rule
    // input  wire [$clog2(NoMstPorts)-1:0]   rule_idx,
    input  wire [AxiAddrWidth-1:0]   rule_start_addr,
    input  wire [AxiAddrWidth-1:0]   rule_end_addr
);
