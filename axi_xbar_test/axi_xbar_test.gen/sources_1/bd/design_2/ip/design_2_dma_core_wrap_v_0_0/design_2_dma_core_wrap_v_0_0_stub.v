...
// Date        : Wed Feb 19 18:25:08 2025
// Host        : dell running 64-bit Ubuntu 20.04.6 LTS
// Command     : write_verilog -force -mode synth_stub
//               /home/yanry/dma/axi_xbar_test/axi_xbar_test.gen/sources_1/bd/design_2/ip/design_2_dma_core_wrap_v_0_0/design_2_dma_core_wrap_v_0_0_stub.v
...
module design_2_dma_core_wrap_v_0_0(clk, rst_n, testmode, axi_mst_req_aw_id, 
  ...
  axi_slv_req_r_ready)
/* synthesis syn_black_box black_box_pad_pin="rst_n,testmode,axi_mst_req_aw_id[4:0],axi_mst_req_aw_addr[63:0],axi_mst_req_aw_len[7:0],axi_mst_req_aw_size[2:0],axi_mst_req_aw_burst[1:0],axi_mst_req_aw_lock,axi_mst_req_aw_cache[3:0],axi_mst_req_aw_prot[2:0],axi_mst_req_aw_qos[3:0],axi_mst_req_aw_region[3:0],axi_mst_req_aw_atop[5:0],axi_mst_req_aw_user[0:0],axi_mst_req_aw_valid,axi_mst_rsp_aw_ready,axi_mst_req_w_data[63:0],axi_mst_req_w_strb[7:0],axi_mst_req_w_last,axi_mst_req_w_user[0:0],axi_mst_req_w_valid,axi_mst_rsp_w_ready,axi_mst_rsp_b_id[4:0],axi_mst_rsp_b_resp[1:0],axi_mst_rsp_b_user[0:0],axi_mst_rsp_b_valid,axi_mst_req_b_ready,axi_mst_req_ar_id[4:0],axi_mst_req_ar_addr[63:0],axi_mst_req_ar_len[7:0],axi_mst_req_ar_size[2:0],axi_mst_req_ar_burst[1:0],axi_mst_req_ar_lock,axi_mst_req_ar_cache[3:0],axi_mst_req_ar_prot[2:0],axi_mst_req_ar_qos[3:0],axi_mst_req_ar_region[3:0],axi_mst_req_ar_user[0:0],axi_mst_req_ar_valid,axi_mst_rsp_ar_ready,axi_mst_rsp_r_id[4:0],axi_mst_rsp_r_data[63:0],axi_mst_rsp_r_resp[1:0],axi_mst_rsp_r_last,axi_mst_rsp_r_user[0:0],axi_mst_rsp_r_valid,axi_mst_req_r_ready,axi_slv_req_aw_id[5:0],axi_slv_req_aw_addr[63:0],axi_slv_req_aw_len[7:0],axi_slv_req_aw_size[2:0],axi_slv_req_aw_burst[1:0],axi_slv_req_aw_lock,axi_slv_req_aw_cache[3:0],axi_slv_req_aw_prot[2:0],axi_slv_req_aw_qos[3:0],axi_slv_req_aw_region[3:0],axi_slv_req_aw_atop[5:0],axi_slv_req_aw_user[0:0],axi_slv_req_aw_valid,axi_slv_rsp_aw_ready,axi_slv_req_w_data[63:0],axi_slv_req_w_strb[7:0],axi_slv_req_w_last,axi_slv_req_w_user[0:0],axi_slv_req_w_valid,axi_slv_rsp_w_ready,axi_slv_rsp_b_id[5:0],axi_slv_rsp_b_resp[1:0],axi_slv_rsp_b_user[0:0],axi_slv_rsp_b_valid,axi_slv_req_b_ready,axi_slv_req_ar_id[5:0],axi_slv_req_ar_addr[63:0],axi_slv_req_ar_len[7:0],axi_slv_req_ar_size[2:0],axi_slv_req_ar_burst[1:0],axi_slv_req_ar_lock,axi_slv_req_ar_cache[3:0],axi_slv_req_ar_prot[2:0],axi_slv_req_ar_qos[3:0],axi_slv_req_ar_region[3:0],axi_slv_req_ar_user[0:0],axi_slv_req_ar_valid,axi_slv_rsp_ar_ready,axi_slv_rsp_r_id[5:0],axi_slv_rsp_r_data[63:0],axi_slv_rsp_r_resp[1:0],axi_slv_rsp_r_last,axi_slv_rsp_r_user[0:0],axi_slv_rsp_r_valid,axi_slv_req_r_ready" */
/* synthesis syn_force_seq_prim="clk" */;
  ...
  input testmode;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst AWID" *) (* X_INTERFACE_MODE = "master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME axi_mst, DATA_WIDTH 64, PROTOCOL AXI4, ID_WIDTH 5, ADDR_WIDTH 64, AWUSER_WIDTH 1, ARUSER_WIDTH 1, WUSER_WIDTH 1, RUSER_WIDTH 1, BUSER_WIDTH 1, READ_WRITE_MODE READ_WRITE, HAS_BURST 1, HAS_LOCK 1, HAS_PROT 1, HAS_CACHE 1, HAS_QOS 1, HAS_REGION 1, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, SUPPORTS_NARROW_BURST 1, NUM_READ_OUTSTANDING 2, NUM_WRITE_OUTSTANDING 2, MAX_BURST_LENGTH 256, PHASE 0.0, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0" *) output [4:0]axi_mst_req_aw_id;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst BID" *) input [4:0]axi_mst_rsp_b_id;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst ARID" *) output [4:0]axi_mst_req_ar_id;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_mst RID" *) input [4:0]axi_mst_rsp_r_id;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv AWID" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME axi_slv, DATA_WIDTH 64, PROTOCOL AXI4, ID_WIDTH 6, ADDR_WIDTH 64, AWUSER_WIDTH 1, ARUSER_WIDTH 1, WUSER_WIDTH 1, RUSER_WIDTH 1, BUSER_WIDTH 1, READ_WRITE_MODE READ_WRITE, HAS_BURST 1, HAS_LOCK 1, HAS_PROT 1, HAS_CACHE 1, HAS_QOS 1, HAS_REGION 1, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, SUPPORTS_NARROW_BURST 1, NUM_READ_OUTSTANDING 2, NUM_WRITE_OUTSTANDING 2, MAX_BURST_LENGTH 256, PHASE 0.0, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0" *) input [5:0]axi_slv_req_aw_id;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv BID" *) output [5:0]axi_slv_rsp_b_id;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv ARID" *) input [5:0]axi_slv_req_ar_id;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 axi_slv RID" *) output [5:0]axi_slv_rsp_r_id;
