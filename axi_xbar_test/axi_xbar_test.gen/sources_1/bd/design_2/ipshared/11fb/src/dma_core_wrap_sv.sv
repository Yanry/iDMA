...
module dma_core_wrap_sv #(
    ...
    // AXI Slave Interface
    // AW Channel
    input  logic [AxiSlvIdWidth-1:0]  axi_slv_req_aw_id,
    ...
    // B Channel
    output logic [AxiSlvIdWidth-1:0]  axi_slv_rsp_b_id,
    ...
    // AR Channel
    input  logic [AxiSlvIdWidth-1:0]  axi_slv_req_ar_id,
    ...
    // R Channel
    output logic [AxiSlvIdWidth-1:0]  axi_slv_rsp_r_id,
    ...
    dma_core_wrap #(
        ...
        .axi_mst_rsp_i   ( axi_mst_rsp  ),
        .axi_slv_req_i   ( axi_slv_req  ),
        .axi_slv_rsp_o   ( axi_slv_rsp  )
    );

endmodule : dma_core_wrap_sv