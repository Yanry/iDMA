...
#define XPAR_DMA_CORE_WRAP_V_0_BASEADDR 0x80000000
...
int main()
{
    ...
    // }
    *(source_data) = 0x12345678;
    *(target_data) = 0x87654321;
    ...
    Xil_Out64((XPAR_DMA_CORE_WRAP_V_0_BASEADDR+0x10),0x08);     // num byte
