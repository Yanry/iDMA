...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L zynq_ultra_ps_e_vip_v1_0_19 -L xlconstant_v1_1_9 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L axi_bram_ctrl_v4_1_11 -L blk_mem_gen_v8_4_9 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_2 xil_defaultlib.design_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_2 -key {Behavioral:sim_1:Functional:design_2} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_ebcc.protoinst" -protoinst "protoinst_files/design_2.protoinst" -protoinst "protoinst_files/bd_45eb.protoinst" -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/bd_f60c.protoinst" -log simulate.log
}
