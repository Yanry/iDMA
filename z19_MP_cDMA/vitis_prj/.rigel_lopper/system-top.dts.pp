#line 1 "../z19_PS_ddr_cdma/hw/sdt/system-top.dts"
/dts-v1/;
#line 1 "../z19_PS_ddr_cdma/hw/sdt/zynqmp.dtsi"
 ...
 */
#line 1 "../z19_PS_ddr_cdma/hw/sdt/include/dt-bindings/dma/xlnx-zynqmp-dpdma.h"
/* SPDX-License-Identifier: (GPL-2.0 OR MIT) */
/*
 * Copyright 2019 Laurent Pinchart <laurent.pinchart@ideasonboard.com>
 */
#line 1 "../z19_PS_ddr_cdma/hw/sdt/include/dt-bindings/gpio/gpio.h"
/* SPDX-License-Identifier: GPL-2.0 */
/*
...
#line 1 "../z19_PS_ddr_cdma/hw/sdt/include/dt-bindings/interrupt-controller/arm-gic.h"
/* SPDX-License-Identifier: GPL-2.0 OR MIT */
/*
 * This header provides constants for the ARM GIC.
 */
#line 1 "../z19_PS_ddr_cdma/hw/sdt/include/dt-bindings/interrupt-controller/irq.h"
/*
 ...
 * defined in this header.
 */
#line 11 "../z19_PS_ddr_cdma/hw/sdt/include/dt-bindings/interrupt-controller/arm-gic.h"
 ...
 */
#line 1 "../z19_PS_ddr_cdma/hw/sdt/include/dt-bindings/power/xlnx-zynqmp-power.h"
/* SPDX-License-Identifier: GPL-2.0 */
/*
 *  Copyright (C) 2018 Xilinx-2022 Xilinx, Inc.
 * (C) Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved.
 */
#line 1 "../z19_PS_ddr_cdma/hw/sdt/include/dt-bindings/reset/xlnx-zynqmp-resets.h"
/* SPDX-License-Identifier: GPL-2.0 */
/*
 *  Copyright (C) 2018 Xilinx-2022 Xilinx, Inc.
 * (C) Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved.
 */
#line 22 "../z19_PS_ddr_cdma/hw/sdt/zynqmp.dtsi"
/ {
...
#line 1 "../z19_PS_ddr_cdma/hw/sdt/zynqmp-clk-ccf.dtsi"
// SPDX-License-Identifier: GPL-2.0+
/*
 ...
 * Michal Simek <michal.simek@amd.com>
 */
#line 1 "../z19_PS_ddr_cdma/hw/sdt/include/dt-bindings/clock/xlnx-zynqmp-clk.h"
/* SPDX-License-Identifier: GPL-2.0 */
/*
 ...
 *
 */
#line 12 "../z19_PS_ddr_cdma/hw/sdt/zynqmp-clk-ccf.dtsi"
/ {
...
#line 1 "../z19_PS_ddr_cdma/hw/sdt/pl.dtsi"
/ {
	amba_pl: amba_pl {
		ranges;
		compatible = "simple-bus";
		#address-cells = <2>;
		#size-cells = <2>;
		firmware-name = "z19_MP_ddr.bit.bin";
		clocking0: clocking0 {
		...
		axi_cdma_0: dma@80000000 {
			...
			dma_channel_80000000: dma-channel@80000000 {
				xlnx,datawidth = <0x20>;
				xlnx,device-id = <0x0>;
...
#line 1 "../z19_PS_ddr_cdma/hw/sdt/pcw.dtsi"
	&psu_cortexa53_0 {
		xlnx,psu-ep = <1>;
		xlnx,rable = <0>;
	...
	&amba {
		...
		psu_ddr_0: psu_ddr@0 {
			...
			xlnx,ddrc-act-freq-hz = <1199988037>;
		...
		psu_ddr_1: psu_ddr@800000000 {
			...
			status = "okay";
			xlnx,ip-name = "psu_ddr";
			reg = <0x00000008 0x00000000 0x00000001 0x80000000>;
			xlnx,name = "psu_ddr_1";
		};
	...
	&mc {
		...
		xlnx,ddrc-clk-freq-hz = <599994019>;
		xlnx,qos-enable = <0>;
...
#line 6 "../z19_PS_ddr_cdma/hw/sdt/system-top.dts"
/ {
	device_id = "xczu19eg";
	slrcount = <1>;
	family = "ZynqMP";
	...
	cpus_a53: cpus-a53@0 {
		...
		address-map = <0x0 0xf0000000 &amba 0x0 0xf0000000 0x0 0x10000000>,
			      ...
			      <0x0 0x82000000 &axi_bram_ctrl_0_memory 0x0 0x82000000 0x0 0x20000>,
			      <0x0 0x82000000 &axi_bram_ctrl_0 0x0 0x82000000 0x0 0x20000>,
			      ...
			      <0x00000008 0x00000000 &psu_ddr_1_memory 0x00000008 0x00000000 0x00000001 0x80000000>,
			      <0x0 0x80000000 &axi_cdma_0 0x0 0x80000000 0x0 0x10000>,
			      ...
			      <0x0 0xff060000 &can0 0x0 0xff060000 0x0 0x10000>,
	...
	cpus_r5_0: cpus-r5@0 {
		...
		address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
			      ...
			      <0x82000000 &axi_bram_ctrl_0_memory 0x82000000 0x20000>,
			      <0x82000000 &axi_bram_ctrl_0 0x82000000 0x20000>,
			      ...
			      <0x80000000 &axi_cdma_0 0x80000000 0x10000>,
